...
const infiniteRechargeSurvey = {
  "metrics": [
    { "name": "Team left community?", "type": "toggle", "category": "Auto1", "group": "Auto (Qualitative)" },
    { "name": "Team collected items?", "type": "toggle", "category": "Auto1"},
    { "name": "Auto Charge station", "type": "select", "category": "Auto1","values":["No","Docked","Engaged"]},

    //{ "name": "toggletesting", "type": "togglegrid", "group":"Points" },

    // { "name": "teleopgrid", "type": "togglegrid", "group": "Teleop" },

    { "name": "Top Cones", "type": "number", "category": "AutoCubes", "group": "Auto (Cubes)"},
    { "name": "Middle Cones", "type": "number", "category": "AutoCubes"},
    { "name": "Bottom Cones", "type": "number", "category": "AutoCubes" },

    { "name": "Top Cones", "type": "number", "category": "AutoCones", "group": "Auto (Cones)"},
    { "name": "Middle Cones", "type": "number", "category": "AutoCones" },
    { "name": "Bottom Cones", "type": "number", "category": "AutoCones" },

    { "name": "Top Cube", "type": "number", "category": "TeleopCubes", "group": "Teleop (Cubes)"},
    { "name": "Middle Cube", "type": "number", "category": "TeleopCubes" },
    { "name": "Bottom Cube", "type": "number", "category": "TeleopCubes", },

    { "name": "Top Cone", "type": "number", "category": "TeleopCones", "group": "Teleop (Cones)"},
    { "name": "Middle Cone", "type": "number", "category": "TeleopCones" },
    { "name": "Bottom Cone", "type": "number", "category": "TeleopCones" },

    { "name": "Team attempts Charge?", "type": "toggle", "category": "Endgame", "group": "Endgame (Charger)" },
    { "name": "Charge station", "type": "select", "category": "Endgame", "values":["No","Docked","Engaged"]},
    // { "name":"Links","type":"number"},

    { "name": "Extra Notes", "type": "text", "category": "Notes", "tip": "Fouls, Disabled,etc..." }]
};
